...
! function(t, e) {
    ...
    function pt(t, e, i) {
        ...
        if (t._sorted) {
            ...
            d && (n = J(Math.min(it(r, l, h)
                .lo, i ? s : it(e, l, a.getPixelForValue(h))
                .lo), 0, s - 1)), o = u ? J(Math.max(it(r, a.axis, c, !0)
                .hi + 1, i ? 0 : it(e, l, a.getPixelForValue(c), !0)
                .hi + 1), n, s) - n : s - n
        }
        return {
            start: n,
    ...
    class bt {
        ...
        add(t, e) {
            e && e.length && this._getAnims(t)
                .items.push(...e)
        }
        has(t) {
            return this._getAnims(t)
                .items.length > 0
        }
        start(t) {
    ...
    function zt(t, e, i, s) {
        return (Array.isArray(e) ? t(e[0], e[1], e[2]) : t(e, i, s))
            .map(Mt)
    }
    function Ft(t, e, i) {
        return zt(Lt, t, e, i)
    ...
    class Zt {
        constructor(t) {
            ...
            let i;
            var s, n, o;
            "object" === e ? i = Kt(t) : "string" === e && (o = (s = t)
                .length, "#" === s[0] && (4 === o || 5 === o ? n = {
                    r: 255 & 17 * St[s[1]],
                    g: 255 & 17 * St[s[2]],
                    b: 255 & 17 * St[s[3]],
                    a: 5 === o ? 17 * St[s[4]] : 255
    ...
    function Te(t, e) {
        (e = e || t.getContext("2d"))
        .save(), e.resetTransform(), e.clearRect(0, 0, t.width, t.height), e.restore()
    }
    function Le(t, e, i, s) {
        Ee(t, e, i, s, null)
    }
        ...
        return e || (e = t._keys = function(t) {
            ...
            for (const i of t)
                for (const t of Object.keys(i)
                        .filter((t => !t.startsWith("_")))) e.add(t);
            return Array.from(e)
        }(t._scopes)), e
    }
    function ii(t, e, i, s) {
    ...
    function Si(t, e) {
        ...
        s && !("" + s)
            .match(xi) && (console.warn('Invalid font style specified: "' + s + '"'), s = void 0);
        const n = {
        ...
        modes: {
            index(t, e, i, s) {
                const n = ve(e, t),
                    ...
                    l = [];
                return r.length ? (t.getSortedVisibleDatasetMetas()
                    .forEach((t => {
                        const e = r[0].index,
                            i = t.data[e];
                        i && !i.skip && l.push({
    ...
    function Is(t, e, i, s) {
        for (const n of e.getMatchingVisibleMetas(s)
                .reverse()) {
            const e = t[n.index];
    ...
    class Ns {
        ...
        updateElement(t, e, i, s) {
            Bs(s) ? Object.assign(t, i) : this._resolveAnimations(e, s)
                .update(t, i)
        }
        updateSharedOptions(t, e, i) {
            t && !Bs(e) && this._resolveAnimations(void 0, e)
                .update(t, i)
        }
        _setStyle(t, e, i, s) {
            t.active = s;
            const n = this.getStyle(e, s);
            this._resolveAnimations(e, i, s)
                .update(t, {
        ...
        _onDataPush() {
            ...
            this._sync(["_insertElements", this.getDataset()
                .data.length - t, t
            ])
        }
        _onDataPop() {
    ...
    class Js extends Hs {
        ...
        _isVisible() {
            ...
            return "auto" !== t ? !!t : this.getMatchingVisibleMetas()
                .length > 0
        }
        ...
        _computeLabelItems(t) {
            ...
            if ("top" === s) w = this.bottom - p, k = this._getXAxisLabelAlignment();
                ...
                k = this._getYAxisLabelAlignment(f)
                    .textAlign
            }
        ...
        _getYAxisLabelAlignment(t) {
            ...
            } = this.options, o = t + n, a = this._getLabelSizes()
                .widest.width;
            let r, l;
        ...
        getLineWidthForValue(t) {
            ...
            if (i >= 0) {
                return e.setContext(this.getContext(i))
                    .lineWidth
            }
            return 0
        }
        ...
        drawBorder() {
            ...
            if (!o) return;
            const a = s.setContext(this.getContext(0))
                .lineWidth,
                r = this._borderValue;
            let l, h, c, d;
        ...
        _resolveTickFontOptions(t) {
            return Si(this.options.ticks.setContext(this.getContext(t))
                .font)
        }
        _maxDigits() {
            const t = this._resolveTickFontOptions(0)
                .lineHeight;
    ...
    class sn {
        ...
        notify(t, e, i, s) {
            ...
            const n = s ? this._descriptors(t)
                .filter(s) : this._descriptors(t),
    ...
    function xn(t, e, i) {
        ...
        if (!o) {
            o = {
                resolver: je(e, i),
                subPrefixes: i.filter((t => !t.toLowerCase()
                    .includes("hover")))
            }, s.set(n, o)
        }
        return o
    }
    const _n = t => o(t) && Object.getOwnPropertyNames(t)
        .some((e => S(t[e])));
    ...
    class An {
        ...
        _updateMetasets() {
            ...
            this._sortedMetasets = t.slice(0)
                .sort(Mn("order", "index"))
        }
        ...
        _getUniformDataChanges() {
            ...
            const e = this.data.datasets.length,
                i = e => new Set(t.filter((t => t[0] === e))
                    .map(((t, e) => e + "," + t.splice(1)
                        .join(",")))),
                s = i(0);
            for (let t = 1; t < e; t++)
                if (!P(s, i(t))) return;
        ...
        getDatasetMeta(t) {
            const e = this.data.datasets[t],
                i = this._metasets;
            let s = i.filter((t => t && t._dataset === e))
                .pop();
            return s || (s = {
                type: null,
                data: [],
        ...
        updateHoverStyle(t, e, i) {
            ...
            for ("dataset" === e && (n = this.getDatasetMeta(t[0].datasetIndex), n.controller["_" + s + "DatasetHoverStyle"]()), a = 0, r = t.length; a < r; ++a) {
                o = t[a];
                const e = o && this.getDatasetMeta(o.datasetIndex)
                    .controller;
        ...
        isPluginEnabled(t) {
            return 1 === this._plugins._cache.filter((e => e.plugin.id === t))
                .length
        }
    ...
    class jn extends Ns {
        ...
        _getRotationExtents() {
            ...
            for (let i = 0; i < this.chart.data.datasets.length; ++i)
                if (this.chart.isDatasetVisible(i) && this.chart.getDatasetMeta(i)
                    .type === this._type) {
    ...
    class $n extends Ns {
        ...
        countVisibleElements() {
            ...
            let e = 0;
            return t.data.forEach(((t, i) => {
                !isNaN(this.getParsed(i)
                    .r) && this.chart.getDataVisibility(i) && e++
            })), e
        }
        _computeAngle(t, e, i) {
            return this.chart.getDataVisibility(t) ? $(this.resolveDataElementOptions(t, e)
                .angle || i) : 0
        }
    }
    var Yn = Object.freeze({
        ...
        BarController: class extends Ns {
            ...
            initialize() {
                ...
                this._cachedMeta.stack = this.getDataset()
                    .stack
            }
            update(t) {
                const e = this._cachedMeta;
            ...
            _getStacks(t, e) {
                const {
                    iScale: i
                } = this._cachedMeta, n = i.getMatchingVisibleMetas(this._type)
                    .filter((t => t.controller.options.grouped)), o = i.options.stacked, a = [], r = t => {
            ...
            _getStackCount(t) {
                return this._getStacks(void 0, t)
                    .length
            }
        ...
        BubbleController: class extends Ns {
            ...
            parsePrimitiveData(t, e, i, s) {
                ...
                for (let t = 0; t < n.length; t++) n[t]._custom = this.resolveDataElementOptions(t + i)
                    .radius;
                return n
            }
            parseArrayData(t, e, i, s) {
                ...
                for (let t = 0; t < n.length; t++) {
                    const s = e[i + t];
                    n[t]._custom = l(s[2], this.resolveDataElementOptions(t + i)
                        .radius)
                }
                return n
            }
            ...
            updateElements(t, e, i, s) {
                ...
                for (let a = e; a < e + i; a++) {
                    const e = t[a],
                        ...
                        r = n.getPointPositionForValue(a, this.getParsed(a)
                            .r),
                        l = o ? n.xCenter : r.x,
                        h = o ? n.yCenter : r.y,
                        c = {
    ...
    class no extends Hs {
        ...
        draw(t, e, i, s) {
            ...
            (this.points || [])
            .length && n.borderWidth && (t.save(), so(t, this, i, s), t.restore()), this.animated && (this._pointsUpdated = !1, this._path = void 0)
        }
    }
    function oo(t, e, i, s) {
        const n = t.options,
        ...
        BarElement: class extends Hs {
            ...
            draw(t) {
                const {
                    ...
                    inner: n,
                    outer: o
                } = lo(this), a = (r = o.radius)
                    .topLeft || r.topRight || r.bottomLeft || r.bottomRight ? He : co;
                var r;
    ...
    class Eo extends bo {
        ...
        generateTickLabels(t) {
            bo.prototype.generateTickLabels.call(this, t), this._pointLabels = this.getLabels()
                .map(((t, e) => {
        ...
        drawLabels() {
            ...
            t.save(), t.translate(this.xCenter, this.yCenter), t.rotate(s), t.textAlign = "center", t.textBaseline = "middle", this.ticks.forEach(((s, a) => {
                ...
                if (n = this.getDistanceFromCenterForValue(this.ticks[a].value), r.showLabelBackdrop) {
                    t.font = l.string, o = t.measureText(s.label)
                        .width, t.fillStyle = r.backdropColor;
    ...
    class No extends Js {
        ...
        _generate() {
            ...
            return d !== i && "ticks" !== s.bounds && 1 !== u || Bo(c, d, g), Object.keys(c)
                .sort(zo)
                .map((t => +t))
        }
        getLabelForValue(t) {
        ...
        beforeElementsUpdate: (t, e, i) => {
            ...
            t.data.datasets.forEach(((e, o) => {
                ...
                let {
                    ...
                    return l && (n = J(it(e, o.axis, a)
                        .lo, 0, i - 1)), s = h ? J(it(e, o.axis, r)
                        .hi + 1, n, i) - n : i - n, {
                        start: n,
                        count: s
                    }
        ...
        const n = function(t) {
            ...
            if (e.getPointPositionForValue) return function(t) {
                const {
                    scale: e,
                    fill: i
                } = t, s = e.options, n = e.getLabels()
                    .length, a = s.reverse ? e.max : e.min, r = function(t, e, i) {
                        let s;
    ...
    class xa extends Hs {
        ...
        _fitRows(t, e, i, s) {
            ...
            return this.legendItems.forEach(((t, f) => {
                const g = i + e / 2 + n.measureText(t.text)
                    .width;
            ...
            return this.legendItems.forEach(((t, o) => {
                const {
                    ...
                    const o = function(t, e, i, s) {
                            ...
                            return e + i.size / 2 + s.measureText(n)
                                .width
                        }(s, t, e, i),
                        a = function(t, e, i) {
                            let s = t;
        ...
        defaults: {
            ...
            labels: {
                ...
                generateLabels(t) {
                    ...
                    return t._getSortedDatasetMetas()
                        .map((t => {
    ...
    class va extends Hs {
        ...
        update(t, e) {
            ...
            const o = s * Si(i.font)
                .lineHeight + this._padding.height;
    ...
    class Va extends Hs {
        ...
        update(t, e) {
            ...
            this._tooltipItems = o, this.$context = void 0, n && this._resolveAnimations()
                .update(this, n), t && i.external && i.external.call(this, {
                    chart: this.chart,
                    tooltip: this,
                    replay: e
                })
        ...
        _drawColorBox(t, e, i, s, n) {
            ...
            if (n.usePointStyle) {
                ...
                const e = s.leftForLtr(u, h),
                    ...
                    r = wi(a.borderRadius);
                Object.values(r)
                    .some((t => 0 !== t)) ? (t.beginPath(), t.fillStyle = n.multiKeyBackground, He(t, {
                        x: e,
                        y: g,
                        w: h,
                        h: l,
        ...
        _updateAnimationTarget(t) {
            ...
            if (s || n) {
                ...
                const o = this._size = Oa(this, t),
                    ...
                    r = Ta(e, t, a),
                    l = La(t, a, r, e);
                s._to === l.x && n._to === l.y || (this.xAlign = r.xAlign, this.yAlign = r.yAlign, this.width = o.width, this.height = o.height, this.caretX = i.x, this.caretY = i.y, this._resolveAnimations()
                    .update(this, l))
            }
        }
        _willRender() {
        ...
        _getActiveElements(t, e, i, s) {
            const n = this.options;
            if ("mouseout" === t.type) return [];
            if (!s) return e.filter((t => this.chart.data.datasets[t.datasetIndex] && void 0 !== this.chart.getDatasetMeta(t.datasetIndex)
