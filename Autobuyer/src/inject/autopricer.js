            ...
            return new Promise(async (resolve) => {
                for (const paragraph of paragraphs) {
                    ...
                    if (contents.includes('I am too busy right now, please come back in about ')) {
                        ...
                        await setVARIABLE("AUTOKQ_STATUS", `Shop Wizard Ban Detected! Sleeping for ${bannedMinutes} Minutes or so...`);
                        ...
                        await setVARIABLE("AUTOKQ_STATUS", "Shop Wizard is Usable Again!");
                        window.location.reload();
                    }
                }
            ...
            if(isKQRunning){
                ...
                await WaitForElement(".wizard-results-price", 0).then(async (searchResults) => {
                    ...
                    async function GoToLowestPricedShop(){
                        await setVARIABLE("AUTOKQ_STATUS", "Search Successful! Choosing Lowest Price...");
