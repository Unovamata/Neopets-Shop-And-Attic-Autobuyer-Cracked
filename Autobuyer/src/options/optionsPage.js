...
$("#ATTIC_RUN_BETWEEN_HOURS").bind("input propertychange", (function () {
  try {
...
$("#RUN_BETWEEN_HOURS").bind("input propertychange", (function () {
  try {
...
resetButton.onclick = function (_) {
  ...
  $("#RUN_BETWEEN_HOURS").val("[" + _.RUN_BETWEEN_HOURS + "]");
