...
async function DisplayAtticTimes(){    
  ...
  lastRestockTime = ParseStringTime(TimezoneDate(lastRestockingTime)),
...
function ShowOrHide() {
  $("#USE_ITEM_DB").is(":checked") ? (
    ...
    $(".restock-hide").show(), $(".db-hide").hide()
  );
  ...
  $("#IS_TURBO").is(":checked") ? (
    ...
    $(".turbo-tag").hide(), $(".turbo-hide").show()
  );
...
$("#SEND_TO_SDB_AFTER_PURCHASE").on("change", (function () {
...
$("#ATTIC_MAX_REFRESH").bind("input propertychange", (function () {
...
$("#ATTIC_ITEM_DB_MIN_PROFIT_PERCENT").bind("input propertychange", (function () {
  setATTIC_ITEM_DB_MIN_PROFIT_PERCENT($("#ATTIC_ITEM_DB_MIN_PROFIT_PERCENT").val())
}));
$("#ATTIC_MIN_BUY_TIME").bind("input propertychange", (function () {
  setATTIC_MIN_BUY_TIME($("#ATTIC_MIN_BUY_TIME").val())
}));
$("#ATTIC_MAX_BUY_TIME").bind("input propertychange", (function () {
  setATTIC_MAX_BUY_TIME($("#ATTIC_MAX_BUY_TIME").val())
}));
...
$("#MIN_REFRESH").bind("input propertychange", (function () {
  setMIN_REFRESH($("#MIN_REFRESH").val())
}));
$("#MAX_REFRESH").bind("input propertychange", (function () {
  setMAX_REFRESH($("#MAX_REFRESH").val())
}));
$("#ITEM_DB_MIN_PROFIT_NPS").bind("input propertychange", (function () {
  setITEM_DB_MIN_PROFIT_NPS($("#ITEM_DB_MIN_PROFIT_NPS").val())
}));
$("#ITEM_DB_MIN_PROFIT_PERCENT").bind("input propertychange", (function () {
  setITEM_DB_MIN_PROFIT_PERCENT($("#ITEM_DB_MIN_PROFIT_PERCENT").val())
}));
$("#MIN_REFRESH_STOCKED").bind("input propertychange", (function () {
  setMIN_REFRESH_STOCKED($("#MIN_REFRESH_STOCKED").val())
}));
$("#MAX_REFRESH_STOCKED").bind("input propertychange", (function () {
  setMAX_REFRESH_STOCKED($("#MAX_REFRESH_STOCKED").val())
}));
$("#ITEMS_TO_CONSIDER_STOCKED").bind("input propertychange", (function () {
  setITEMS_TO_CONSIDER_STOCKED($("#ITEMS_TO_CONSIDER_STOCKED").val())
}));
$("#MIN_CLICK_ITEM_IMAGE").bind("input propertychange", (function () {
  setMIN_CLICK_ITEM_IMAGE($("#MIN_CLICK_ITEM_IMAGE").val())
}));
$("#MAX_CLICK_ITEM_IMAGE").bind("input propertychange", (function () {
  setMAX_CLICK_ITEM_IMAGE($("#MAX_CLICK_ITEM_IMAGE").val())
}));
$("#MIN_CLICK_CONFIRM").bind("input propertychange", (function () {
  setMIN_CLICK_CONFIRM($("#MIN_CLICK_CONFIRM").val())
}));
$("#MAX_CLICK_CONFIRM").bind("input propertychange", (function () {
  setMAX_CLICK_CONFIRM($("#MAX_CLICK_CONFIRM").val())
}));
$("#MIN_OCR_PAGE").bind("input propertychange", (function () {
  setMIN_OCR_PAGE($("#MIN_OCR_PAGE").val())
}));
$("#MAX_OCR_PAGE").bind("input propertychange", (function () {
  setMAX_OCR_PAGE($("#MAX_OCR_PAGE").val())
}));
...
$("#SHOULD_SOUND_ALERTS").on("change", (function () {
  setSHOULD_SOUND_ALERTS($("#SHOULD_SOUND_ALERTS").is(":checked"));
}));
...
$("#SHOULD_MULTICLICK_CAPTCHA").on("change", function () {
  const isChecked = $("#SHOULD_MULTICLICK_CAPTCHA").is(":checked");
  setVARIABLE("SHOULD_MULTICLICK_CAPTCHA", isChecked);
});
