...
function updateLastRefreshMs() { "" != $("#ATTIC_LAST_REFRESH_DATE").val() && "" != $("#ATTIC_LAST_REFRESH_TIME").val() && (setATTIC_LAST_REFRESH_MS(getPacificTimeDateObjFromInputs().valueOf()), setATTIC_PREV_NUM_ITEMS(24)) }

function updateDateTimeInputs(_) { var E = moment(_).tz("America/Los_Angeles").format("YYYY-MM-DD"),
        T = moment(_).tz("America/Los_Angeles").format("YYYY-MM-DD HH:mm:ss").split(" ")[1];
    $("#ATTIC_LAST_REFRESH_DATE").val(E), $("#ATTIC_LAST_REFRESH_TIME").val(T) }
